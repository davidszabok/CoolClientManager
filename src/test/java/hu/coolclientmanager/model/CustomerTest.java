...
class CustomerTest {
    ...
    @Test
    void getId() {
        Address address = new Address("Budapest", "Fő utca", "10/A"); // String típusú házszám
    ...
    @Test
    void getCompanyName() {
        Address address = new Address("Budapest", "Fő utca", "10/A");
        Customer customer = new Customer(1, "Tesla Hungary Kft.", "12345678", address);
    ...
    void setShippingAddresses() {
        Address address1 = new Address("Szeged", "Tisza utca", "5/B");
        Address address2 = new Address("Debrecen", "Kossuth tér", "12");
        Customer customer = new Customer(1, "Tesla Hungary Kft.", "12345678", new Address("Budapest", "Fő utca", "10/A"));
